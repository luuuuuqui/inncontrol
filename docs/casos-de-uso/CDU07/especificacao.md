...
3. O administrador informa os dados do tipo de quarto (nome, descrição e características).
...
- **FE2 – Tipo de quarto já existente:**  
  Se o administrador tentar cadastrar um tipo de quarto já existente, o sistema exibirá uma mensagem informando o conflito.
